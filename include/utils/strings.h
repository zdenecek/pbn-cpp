 ...
 * @return The vector of strings
 */
std::vector<std::string> split(const std::string &string, std::function<bool(char)> is_delim);
 ...
 */
void split(const std::string &string, std::vector<std::string> &into);
 ...
 * @param into[out] The vector to put the strings into
 */
void split(const std::string &string, std::vector<std::string> &into, std::function<bool(char)> is_delim);
